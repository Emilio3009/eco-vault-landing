...
export default function Header() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      // Verificar si estamos en la parte superior (sección home)
      if (window.scrollY < 100) {
        setActiveTab('home');
        return; // Salimos de la función
      }
      
      // Buscar la sección activa según el scroll
      ...
      // Si no hay ninguna sección activa y no estamos en la parte superior,
      // podemos mantener la última sección activa o no hacer nada
    };
